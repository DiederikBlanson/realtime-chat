...
const defaultTheme = createTheme({
    palette: {
        background: {
            default: 'rgb(17, 27, 33)'
        }
    }
})

// source: https://github.com/mui/material-ui/blob/v5.14.11/docs/data/material/getting-started/templates/sign-in/SignIn.tsx

interface PropsComponent {
    login: (e: any) => void
}

const App: React.FC<PropsComponent> = (props) => {
    return (
